...
public class DisplayState : MonoBehaviour
{
    ...
    protected TMP_Text ButtonText { get; private set; }
    protected UITweenManager UITweenManager { get; private set; }
   
    public virtual void Setup(Image primaryImage, Image secondaryImage, TMP_Text buttonText, UITweenManager uitweenManager)
    {
