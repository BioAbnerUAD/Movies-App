...
public class UITweenManager : MonoBehaviour
    {
        ...
        public void Tween(TMP_Text textComponent, Color32 to, UnityAction onComplete, float duration = 1)
        {
        ...
        /// </summary>
        public void ForceTween(TMP_Text textComponent, Color32 to, UnityAction onComplete, float duration = 1)
        {
            int instanceId = textComponent.GetInstanceID();
    ...
    public class UITextItem : UIItem
    {
        ...
        public UITextItem(Color32 from, Color32 to, TMP_Text textComponent, UnityAction onComplete, float duration = 1)
